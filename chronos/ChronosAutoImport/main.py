...
SCRIPT_PATH = "C:\\Theseus\\Tools\\dbscripts\\armory_fast_import.sql"
...
if __name__ == "__main__":
    ...
    # Check if file exists (it has to do with windows and it's permissions....)
    ...
    try:
        with connect(
            ...
            sqlLines = [line.strip() for line in sqlLines if not line.strip().startswith("#")]
            sqlLines = " ".join(sqlLines)
            sqlLines = sqlLines.split("; ")
